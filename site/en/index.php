<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../login.php?redirect=en/index.php");
	}
?>
...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.3.0, mkdocs-material-8.2.14">
        ...
        <title>Welcome to MkDocs - Static Documentation Project</title>
...
<p>We also could call translation to images, in this case we would need to use:</p>
<h1 id="image-descriptionassetsimageptjpg"><code>![Image Description](assets/image.pt.jpg)</code></h1>
<h1 id="image-descriptionassetsimageenjpg"><code>![Image Description](assets/image.en.jpg)</code></h1>
